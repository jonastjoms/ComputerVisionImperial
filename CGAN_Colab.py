...
def main():
    ...
    for epoch in range(epochs):
        ...
        fixed_p = '/content/drive/My Drive/computer_vision/results/Fixed_results/MNIST_cGAN_' + str(epoch + 1) + '.png'
    ...
    for p in range(100):
        labled_path = '/content/drive/My Drive/computer_vision/results/'
    ...
    torch.save(G.state_dict(), "/content/drive/My Drive/computer_vision/results/generator_param.pkl")
    torch.save(D.state_dict(), "/content/drive/My Drive/computer_vision/results/discriminator_param.pkl")
    with open('/content/drive/My Drive/computer_vision/results/train_hist.pkl', 'wb') as f:
        pickle.dump(train_hist, f)

    show_train_hist(train_hist, save=True, path='/content/drive/My Drive/computer_vision/results/MNIST_cGAN_train_hist.png')

    images = []
    for e in range(epochs):
        img_name = '/content/drive/My Drive/computer_vision/results/Fixed_results/MNIST_cGAN_' + str(e + 1) + '.png'
        images.append(imageio.imread(img_name))
    imageio.mimsave('/content/drive/My Drive/computer_vision/results/generation_animation.gif', images, fps=5)
